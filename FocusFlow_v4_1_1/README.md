...
| 🎯 Focus | Deep Work sessions with temporary auto-blocking |
| 🎯 Score | Daily productivity score (0–100) + category pie + 8 achievement badges |
...
| 🧭 Coach | On-device insights + weekly report — export JSON / CSV |
