// ===== LockIn — syncManager.js v1.0 =====
// Integration Architecture — PREPARED BUT NOT ACTIVE
...
async function importUserData(payload) {
  if (!payload || !payload.meta || (payload.meta.app !== APP_ID && payload.meta.app !== "focusflow")) {
    throw new Error("Invalid LockIn backup file.");
  }
